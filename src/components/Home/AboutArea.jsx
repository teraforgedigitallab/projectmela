                        ...
                        <div className="relative">
                            ...
                            <div className="flex gap-6">
                                <img
                                    ...
                                    className="rounded-sm object-cover w-40 h-50 md:w-70 md:h-80 shadow-md"
                                />
                                <div className="bg-primary rounded-md text-white flex flex-col justify-center px-8 py-10 w-40 h-50 md:w-70 md:h-70 shadow-lg translate-y-12">
                                    <div className="bg-white/10 rounded p-3 w-fit mb-4">
                                        <IoCheckmark className="text-sm md:text-xl" />
                                    </div>
                                    <h6 className="text-md md:text-xl font-semibold mb-3">Job alert!</h6>
