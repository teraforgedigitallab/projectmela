    ...
    <footer className="w-full bg-white border-t border-gray-100 pt-12 pb-6 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
        ...
        <div className="flex flex-col items-center md:items-start col-span-1">
          ...
          <div className="text-gray-800 text-sm space-y-1 mb-4 text-center md:text-left">
            <div>
              <span className="font-semibold text-gray-800 text-sm">Address:</span> 555 Wall Street, USA, NY
            </div>
            <div>
            ...
            <div>
              <span className="font-semibold text-gray-800 text-sm">Call:</span> 555-555-1234
            </div>
          </div>
          <div className="flex space-x-3 mt-2">
            ...
            >
              <FaPinterestP className="w-4 h-4 text-primary-hover transition-colors duration-200 group-hover:text-white" />
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start col-span-1">
          ...
          <ul className="space-y-4 font-normal text-xs text-gray-700 text-left">
            ...
            <li><a href="#" className="hover:text-primary transition">Jobs Featured</a></li>
            <li><a href="#" className="hover:text-primary transition">Jobs Urgent</a></li>
        ...
        <div className="flex flex-col items-center md:items-start col-span-1">
          ...
          <ul className="space-y-4 font-normal text-xs text-gray-700 text-left">
            ...
            <li><a href="#" className="hover:text-primary transition">Job Packages</a></li>
            <li><a href="#" className="hover:text-primary transition">Jobs Listing</a></li>
            <li><a href="#" className="hover:text-primary transition">Jobs Featured</a></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start col-span-1">
          ...
          {isSubscribed ? (<div className="rounded-md p-3 text-center">
