...
import { SideTestimonial } from '../components';
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row items-stretch">
            <div className="flex-1 flex items-center justify-center py-12 px-4">
                <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
                    <h1 className="text-2xl font-bold text-primary mb-2">{isSignUp ? 'Sign up on Project Mela' : 'Sign in to Project Mela!'}</h1>
                    ...
                    <form onSubmit={handleSignInClick} className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                <div className="flex-1">
                                    ...
                                    <input id="firstName" type="text" required value={firstName} onChange={(e) => setFirstName(e.target.value)}
                                        className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary bg-gray-50" />
                                </div>
                                <div className="flex-1">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary bg-gray-50 pr-10"
                                />
                                <button
                                    type="button"
                        ...
                        <button type="submit" className="w-full bg-primary flex items-center justify-center gap-2 text-white py-2 rounded-lg font-bold hover:bg-primary-hover transition mt-2">
                    ...
                    <button
                        className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2 font-semibold text-gray-700 hover:bg-gray-50 transition"
            ...
            <div className="hidden md:flex md:w-2/5 bg-primary/90 items-center justify-center relative">
