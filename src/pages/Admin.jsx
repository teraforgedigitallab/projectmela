                                ...
                                {activeTab !== 'Users' && (
                                    <div className="flex flex-col space-y-2">
                                        <div className="relative flex items-start">
                                            ...
                                            {/* Sort Tooltip */}
                                            {showSortTooltip && (
                                                <div className="absolute top-full mt-2 right-0 bg-white rounded-lg shadow-lg z-10 w-48">
                            ...
                            <div className="space-y-4">
                                {suggestedCandidates.length === 0 ? (
                                    ...
                                    suggestedCandidates.map((candidate, index) => (
                                        <div key={candidate.id} className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
