...
import { RiMoneyRupeeCircleLine, RiPriceTag3Line, RiUser3Line } from "react-icons/ri";
import { PiClockCountdownBold } from "react-icons/pi";
import { FiAward, FiPhone } from "react-icons/fi";
...
import { getStatusClass } from '../utils/function.jsx';
        ...
        <div className="bg-gray-50 min-h-screen pb-10">
            <ProfileBanner
                ...
                breadcrumbs={[
                    { name: "Home", href: "/" },
                    { name: "Blog", href: "/blog" },
                    { name: "Job Details", href: `/project-detail/${id}` }
                ]}
            />
                    ...
                    <div className="w-full md:w-2/3">
                        <div className="bg-white rounded-sm shadow-md p-8 mb-8">
                            ...
                            <div className="flex items-center mb-6 border-b border-gray-400 pb-4">
                                <div>
                                    <span
                                        className={`inline-block py-1 rounded-full font-semibold text-sm ${getStatusClass(jobData.status)} mb-2`}>
                                        {jobData.status}
                                    </span>

                                    <h1 className="text-2xl font-semibold text-gray-800">{jobData.projectTitle}</h1>
                            ...
                            {/* Job Description */}
                            <div className="mb-8">
                                <h2 className="text-lg font-normal mb-2">Job Description</h2>
                    ...
                    <div className="w-full md:w-1/3 flex flex-col gap-8">
                        ...
                        <div className="bg-white rounded-sm shadow-md p-6 flex gap-4">
                            <button
                                ...
                                className={`w-full py-3 rounded-md font-medium transition-colors flex items-center justify-center cursor-pointer
                                ${isSaved ? 'bg-primary text-white' : 'bg-primary text-white '}`}
                            >
                            ...
                            <button
                                onClick={handleApply}
                                className="w-full bg-primary-hover text-white py-3 rounded-md font-medium transition-colors flex items-center justify-center cursor-pointer"
                            >
                                Apply Now
                            </button>
                        </div>
                        ...
                        {jobData.locationMap && (
                            <div className="bg-white rounded-sm shadow-md p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-4">Job Location</h3>
                                <div>{/* Embed your map here, e.g. iframe or component */}</div>
                            </div>
                        )}
                    </div>
                </div>
